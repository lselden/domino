...
// makes a class with 'length' and 'item' values iterable using ES6 Symbol.iterator
// does nothing if not supported (Node < 6.0). This is pulled directly
// from original implementation in Element.js
exports.addES6Iterator = function(constructor) {
  if (global.Symbol && global.Symbol.iterator) {
    constructor.prototype[global.Symbol.iterator] = function() {
